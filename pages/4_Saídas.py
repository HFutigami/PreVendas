...
if 'senha' not in st.session_state:
    ...
    rlns_sharepoint_url = '/sites/Expedio/Documentos%20Compartilhados/General/Bases/RLNS.xlsx' #xlsx
    pea_sharepoint_url = '/sites/Expedio/Documentos%20Compartilhados/General/Bases/Pedidos/PEA.xlsx' #parquet'
    ...
    def atualizar_pedidos():
        """Atualiza os pedidos sempre que encontrar um arquivo diferente do PEA
        na pasta de pedidos."""